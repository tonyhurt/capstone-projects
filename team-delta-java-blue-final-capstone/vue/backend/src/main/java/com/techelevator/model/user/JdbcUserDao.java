...
//	    }
	    ...
	    public void saveUser(User user) {
	        ...
	        jdbcTemplate.update(insertSql, user.getUsername(), user.getEmail(), hashedPassword, saltString);
	    ...
	    public void changePassword(User user, String newPassword) {
	        ...
	        jdbcTemplate.update("UPDATE users SET password=?, salt=? WHERE id=?", hashedPassword, saltString, user.getUserId());
	    }
	    ...
	    public void updateUserByUserId(User user) {
			...
			jdbcTemplate.update(updateSql, user.getTeamId(), user.getUserId());
	    }
	    ...
	    private User mapResultToUser(SqlRowSet results) {
	    	...
	    	user.setTeamId(results.getInt("team_id"));
