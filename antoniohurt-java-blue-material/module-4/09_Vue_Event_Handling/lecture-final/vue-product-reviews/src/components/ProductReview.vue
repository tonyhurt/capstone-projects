    ...
    <div class="main">
        ...
        <div class="well-display">
            ...
            <div class="well">
                ...
                <span class="amount" @click="filter = 3">{{ numberOfThreeStarReviews }}</span>
                3 Star Review{{ numberOfThreeStarReviews === 1 ? '' : 's' }}
            </div>

            <div class="well">
                <span class="amount" @click="filter = 4">{{ numberOfFourStarReviews }}</span>
        ...
        <a href="#" v-if="showForm === false" v-on:click.prevent="showForm = true">Show Form</a>
...
export default {
    ...
    computed: {
        averageRating(vm) {
            ...
            return Math.round((sum / vm.reviews.length) * 100) / 100;
        },
