	...
	<div class="main-content">
		...
		<div id="grid">
			...
			<c:forEach var="product" items="${products}">
				<c:set var="soldOut" value="${product.remainingStock == 0}" />
				...
				<div class="tile ${product.remainingStock == 0 ? 'sold-out' : '' }">
					...
					<c:when test="${product.topSeller == true}">
						<span class="banner top-seller">TopSeller!</span>
					</c:when>
					</c:choose>
					...
					<div class="details">
						...
						<div class="rating">
							<c:forEach begin="0" end="4" var="ratings">
								<c:choose>
									<c:when test="${product.averageRating >= ratings}">
