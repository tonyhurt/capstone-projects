...
public class CityController {
	...
	public String addNewCity(@Valid @ModelAttribute("newCity") City newCity, BindingResult result, ModelMap map, RedirectAttributes redirectAttributes) {
		...
		// Use addFlashAttributes on the RedirectAttributes object to add a key/value to Flash Scope
		redirectAttributes.addFlashAttribute("city", newCity);
	...
	public String showLogin(ModelMap map, HttpServletRequest req) {
		return "login";
	}
