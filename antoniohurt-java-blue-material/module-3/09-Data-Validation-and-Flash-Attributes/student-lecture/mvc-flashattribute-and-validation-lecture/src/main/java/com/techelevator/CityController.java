...
public class CityController {
	...
	public String showAddCity(ModelMap map) {
		...
		if (!map.containsAttribute("newCity")) {
			map.addAttribute("newCity", new City());
		}
	...
	public String addNewCity(City newCity, BindingResult result, ModelMap map, RedirectAttributes redirectAttributes) {
		...
		//Use addFlashAttributes on the RedirectAttributes object ot add a key/value to Flash Scope
