...
public class Exercises {
	...
	/*
	 4. Given 
	 * 2 arrays of ints, a and b, return true if they have the same first element 
	...
	/*
	 * 
	 * elements...nums[0] nums[1] nums[2]....reverse nums[2] nums[1] nums[0]
	...
	/*a[] b[] array...middle of 3...0 1 2..a[1] b[1]
	 * [1, 2, 3], [4, 5, 6] 
