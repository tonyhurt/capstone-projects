...
//        Equivalent full declaration and assignment
//        int [] arr = new int [3];
//        arr[0] = 80;
//        arr[1] = 8080;
//        arr[2] = 443;
    ...
    */
    public int returnLastElementOfParam(int[] passedInArray) {
        return passedInArray[ passedInArray.length -1 ]; // length - 1 always gives last element of array
    }
    ...
    */
    public int returnVariableFromBlock(int number) {
        ...
        { // A new block with scoped variables
             ...
             result = number * 5; // took away the int from int result
