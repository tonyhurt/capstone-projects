...
public class Exercises {
	...
	public boolean sleepIn(boolean weekday, boolean vacation) {
		...
		// // if vacation TRUE then sleep in
		// if (vacation == true) {
		// return true;
		// }
	...
	public boolean monkeyTrouble(boolean aSmile, boolean bSmile) {
		// If aSmile and bSmile are true, then in Trouble
		if (aSmile == true && bSmile == true) {
			return true;
		}
		// If aSmile and bSmile are false, then in Trouble
	...
	public boolean parrotTrouble(boolean talking, int hour) {
		...
		// if the hour is less than 7 or greater than 20, then parrot is talking,
		// inTrouble, should return true
	 ...
	 *  return their sum. 
	 *  However, sums in the range
	 * 10..19 inclusive, are forbidden,
