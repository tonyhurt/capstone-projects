...
public class Exercises {
	 ...
	 */
	public String[] list2Array(List<String> stringList) { //list to array
	...
	public List<String> reverseList(List<String> stringList) {
		...
		while ( !stringStack.isEmpty() ) {
			reverseOrder.add(stringStack.pop()); 
		}
...
//		loop over ints ininArray
//		
//		double result = ints / 2.0
//		myList.add(result)
	...
	public List<Integer> oddOnly(Integer[] integerArray) {
		...
		List<Integer> odd = new ArrayList<Integer>(0);
