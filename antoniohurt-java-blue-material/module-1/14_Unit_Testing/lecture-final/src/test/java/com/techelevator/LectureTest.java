...
public class LectureTest {
	...
	// Before should instantiate a clean copy of the the object
	@Before
	public void setup() {
		lecture = new Lecture();
	}
	...
	/* or35 */
	@Test
	public void or35_multipe_of_3_but_not_5_returns_true() {
		// Arrange
		// Act
	...
	/* Other or35 Tests 
	 * 
	 * 	- multiple of 3 and not 5
	 *  - multiple of 3 and multiple of 5
	 *  - not multiple of 3 and multiple of 5
	 *  - not multiple of 3 and not multiple of 5
	 *  - 0
	 *  - negative number
	 *  - Integer.Max
	 *  - Integer.Max + 1
	...
	@Test
	public void driving_65_when_birthday_returns_no_ticket() {
		// Arrange
		// Act
	...
	@Test
	public void thurd_of_5_is_1_66() {
