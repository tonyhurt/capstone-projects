...
public class TriangleClassifierTest {
	...
	@Test
	public void identifies_invalid_triangle_with_2_equal_sides() {
	...
	@Test
	public void identifies_invalid_triangle_with_side_of_zero() {
		Assert.assertEquals("invalid", classifier.classify(0, 1, 2));
	}
