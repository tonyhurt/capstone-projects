...
public class SpringJDBCExample {
	...
	public static void main(String[] args) {
		 ...
		 * The datasource used determines whether or not a Connection Pool is used.
		 * */
		...
		/* use the jdbcTemplate "update()" method to run INSERT, UPDATE, and DELETE SQL statements */
		String sqlCreateActor = "INSERT INTO actor(actor_id, first_name, last_name) "+
								"VALUES (?, ?, ?)";
		
		dvdstoreJdbcTemplate.update(sqlCreateActor, 10002, "Craig", "Castelaz");
		...
		/*
		 * *******************************************************
		 *          SEQUENCES USING SELECT nextval()
		 * *******************************************************
		 */
		...
		/*
		 * *******************************************************
		 *      SEQUENCES USING RETURNING AND SQLROWSET
		 * *******************************************************
		 */
		...
		System.out.println("\nReturned new city id: " + newCityId);
		
		/*
		 * *******************************************************
		 *    SEQUENCES USING RETURNING AS OBJECT - ADVANCED
		 * *******************************************************
		 */
		Integer anotherCityId = worldJdbcTemplate.queryForObject(sqlCreateNewCityWithReturning, Integer.class, "Smallville", "USA", "Kansas", 45001);
		System.out.println("\nReturned without RowSet new city id: " + anotherCityId);
	}
}
