...
SELECT name, continent FROM country WHERE gnp > 1000000;
...
SELECT name, continent, population, gnp FROM country WHERE lifeexpectancy > 80;
...
SELECT name, population FROM country WHERE gnp > 1000000 AND population < 100000000;
...
SELECT (2017 - indepyear) AS number_of_years_since_independence FROM country WHERE indepyear IS NOT NULL;